...
Source0  : https://cpan.metacpan.org/authors/id/T/TI/TINITA/YAML-PP-0.034.tar.gz
...
%prep
%setup -q -n YAML-PP-0.034
cd %{_builddir}/YAML-PP-0.034
...
cp %{_builddir}/YAML-PP-0.034/LICENSE %{buildroot}/usr/share/package-licenses/perl-YAML-PP/ce5601188e3eaef45d9491ce50709337e05115ef
if test -f Makefile.PL; then
