...
Version  : 0.024
Release  : 9
URL      : https://cpan.metacpan.org/authors/id/T/TI/TINITA/YAML-PP-0.024.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/T/TI/TINITA/YAML-PP-0.024.tar.gz
...
%prep
%setup -q -n YAML-PP-0.024
cd %{_builddir}/YAML-PP-0.024
...
cp %{_builddir}/YAML-PP-0.024/LICENSE %{buildroot}/usr/share/package-licenses/perl-YAML-PP/5caa96b703c0cb8b851a5c90a3cf65aeae8b45df
if test -f Makefile.PL; then
