...
%prep
%setup -q -n YAML-PP-0.026
cd %{_builddir}/YAML-PP-0.026
...
cp %{_builddir}/YAML-PP-0.026/LICENSE %{buildroot}/usr/share/package-licenses/perl-YAML-PP/5caa96b703c0cb8b851a5c90a3cf65aeae8b45df
if test -f Makefile.PL; then
