...
%prep
%setup -q -n YAML-PP-v0.39.0
cd %{_builddir}/YAML-PP-v0.39.0
pushd ..
cp -a YAML-PP-v0.39.0 buildavx2
popd
pushd ..
cp -a YAML-PP-v0.39.0 buildapx
popd
...
cp %{_builddir}/YAML-PP-v%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-YAML-PP/a7065932cc0dce790094bd898295fcc2db4e923d || :
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-YAML-PP/a7065932cc0dce790094bd898295fcc2db4e923d
