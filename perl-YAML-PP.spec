...
Source0  : https://cpan.metacpan.org/authors/id/T/TI/TINITA/YAML-PP-0.031.tar.gz
...
%prep
%setup -q -n YAML-PP-0.031
cd %{_builddir}/YAML-PP-0.031
...
cp %{_builddir}/YAML-PP-0.031/LICENSE %{buildroot}/usr/share/package-licenses/perl-YAML-PP/d1963a62fa3e917b172fbde29991102d7716e4a5
if test -f Makefile.PL; then
