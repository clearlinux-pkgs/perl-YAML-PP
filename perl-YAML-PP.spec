...
Source0  : https://cpan.metacpan.org/authors/id/T/TI/TINITA/YAML-PP-v0.37.0.tar.gz
...
%prep
%setup -q -n YAML-PP-v0.37.0
cd %{_builddir}/YAML-PP-v0.37.0
pushd ..
cp -a YAML-PP-v0.37.0 buildavx2
popd
