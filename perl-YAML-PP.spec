...
Source0  : https://cpan.metacpan.org/authors/id/T/TI/TINITA/YAML-PP-0.025.tar.gz
...
%prep
%setup -q -n YAML-PP-0.025
cd %{_builddir}/YAML-PP-0.025
...
cp %{_builddir}/YAML-PP-0.025/LICENSE %{buildroot}/usr/share/package-licenses/perl-YAML-PP/5caa96b703c0cb8b851a5c90a3cf65aeae8b45df
if test -f Makefile.PL; then
